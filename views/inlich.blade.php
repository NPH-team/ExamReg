...
<a href="{{ url('/print') }}" class="btnprn btn btn-success" style="float: right;">Print</a>
<a href="pdf" class="btn btn-success"  style="float: right; margin-right:10px;margin-bottom:10px;">Dowload</a>
</div>
@endsection